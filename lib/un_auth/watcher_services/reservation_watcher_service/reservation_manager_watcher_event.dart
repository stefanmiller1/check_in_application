...
class ReservationManagerWatcherEvent with _$ReservationManagerWatcherEvent {
  ...
  const factory ReservationManagerWatcherEvent.watchDiscoveryReservationsList(List<ReservationSlotState> resState, int? hoursAhead, int? hoursPast) = _WatchDiscoveryReservationsList;
  ...
  const factory ReservationManagerWatcherEvent.watchCurrentUsersReservations(List<ReservationSlotState> resState, UserProfileModel currentUser, bool isResInvitation) = _WatchCurrentUsersReservations;
