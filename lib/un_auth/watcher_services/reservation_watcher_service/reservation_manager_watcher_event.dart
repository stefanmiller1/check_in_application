...
class ReservationManagerWatcherEvent with _$ReservationManagerWatcherEvent {
  ...
  const factory ReservationManagerWatcherEvent.watchCurrentUsersReservations(UserProfileModel currentUser, bool isResInvitation) = _WatchCurrentUsersReservations;
