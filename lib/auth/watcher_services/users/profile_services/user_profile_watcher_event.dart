...
class UserProfileWatcherEvent with _$UserProfileWatcherEvent {
  ...
  const factory UserProfileWatcherEvent.watchProfileAllAttendingResStarted(ContactStatus? status, AttendeeType? attendingType, int? limit, String? userId) = _WatchProfileAllAttendingResStarted;
  ...
  const factory UserProfileWatcherEvent.watchAllProfileFromUserIdsStarted(List<String> userIds) = _WatchAllProfileFromUserIdsStarted;
  const factory UserProfileWatcherEvent.allProfilesFromUserIdsReceived(Either<AuthFailure, List<UserProfileModel>> failedItems) = _AllProfilesFromUserIdsReceived;
